...
export function ForumListPage(props: ForumListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getForums({
        relations: ['user', 'discussion.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('discussion', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'discussion',
          header: 'Discussion',
          accessorKey: 'discussion',
          cell: ({ row: { original: record } }: any) => record?._count?.discussion,
        }
      : null,
