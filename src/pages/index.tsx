  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Community Platform: Empowering Connections and Knowledge Sharing. Consume blogs, documentation, videos, reels, streams, and engage in one-on-one chats and forum discussions. Building relationships just like Facebook."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Community Platform: Empowering Connections and Knowledge Sharing. Consume blogs, documentation, videos, reels, streams, and engage in one-on-one chats and forum discussions. Building relationships just like Facebook.`}
            </Text>
            <Box
