...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['administrator', 'content-creator', 'moderator', 'subscriber', 'guest'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Forums', path: '/forums', entity: 'forum', service: AccessServiceEnum.PROJECT, icon: FiMessageSquare },
    {
      name: 'Subscriptions',
      path: '/subscriptions',
      entity: 'subscription',
